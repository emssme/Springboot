...
<div class="l-content" style="width:1280px;margin:20px auto;">
  <form action="${path0}/board/update.do" method="post">
    ...
    <table class="pure-table">
      ...
      <tr>
        ...
        <td colspan="12">
          <input type="text" id="title" name="title" value="${board.title}" maxlength="100" required>
        </td>
      </tr>
      <tr>
        <td colspan="12" style="font-size: 15px;" class="p-4">
          <textarea name="content" id="content" cols="30" rows="10"  maxlength="1000" required>${board.content}</textarea></td>
      </tr>
      <tr>
        <td colspan="2">

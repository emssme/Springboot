...
<div class="l-content" style="width:1280px;margin:20px auto;">
  <table class="pure-table">
    ...
    <tr>
      <td colspan="8">
        <a href="${path0}/board/list.do">목록</a>
        <a href="${path0}/board/update.do?seq=${board.seq}">수정</a>
        <a href="${path0}/board/delete.do?seq=${board.seq}">삭제</a>
      </td>
    </tr>
    <tr>
      <th class="text-center">제목</th>
      <td colspan="12">${board.title}</td>
    </tr>
    <tr>
      <th class="text-center">작성자</th>
      <td colspan="3">${board.author}</td>
      ...
      <td colspan="3">${board.visited}</td>
      <th class="text-center">추천수</th>
      <td colspan="3">${board.rec}</td>
    </tr>
    <tr>
      <td colspan="12" style="font-size: 15px;" class="p-4">${board.content}</td>
    </tr>
    </tbody>
  </table>
</div>
